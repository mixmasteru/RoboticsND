...
if("FALSE" STREQUAL "TRUE")
  set(librealsense_SOURCE_PREFIX /tmp/binarydeb/ros-kinetic-librealsense-1.12.1)
  set(librealsense_DEVEL_PREFIX /tmp/binarydeb/ros-kinetic-librealsense-1.12.1/obj-x86_64-linux-gnu/devel)
  ...
  set(librealsense_INSTALL_PREFIX /opt/ros/kinetic)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'librealsense' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '\${prefix}/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT librealsense_NUM_DUMMY_TARGETS)
      set(librealsense_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::librealsense::wrapped-linker-option${librealsense_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR librealsense_NUM_DUMMY_TARGETS "${librealsense_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::librealsense::wrapped-linker-option${librealsense_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND librealsense_LIBRARIES "${interface_target_name}")
